...
import motorLeadsRoutes from './routes/motorLeads';
import adminFieldsRoutes from './routes/adminFields';
...
app.use('/api/motor-leads', motorLeadsRoutes);
app.use('/api/admin-fields', adminFieldsRoutes);
